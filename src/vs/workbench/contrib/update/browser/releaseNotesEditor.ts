 ...
 * - `IN_PRODUCT` - Content shown in Pointer (both Stable and Insiders)
 * - `WEB` - Content shown on the website only
 * - `STABLE` - Content shown in Pointer Stable only
 * - `INSIDERS` - Content shown in Pointer Insiders only
 *
