 ...
 * {@link IDetachedTerminalInstance} (a terminal used elsewhere in Pointer UI).
 */
 ...
 * to represent terminals that appear in other parts of the Pointer UI outside
...
export interface IXtermTerminal extends IDisposable {
	...
	*/
	...
	/**
	 * Selects the content between the two markers by their Pointer OSC `SetMarker`
...
export interface IDetachedXtermTerminal extends IXtermTerminal {
	...
	/**
	 * Updates the xterm log level to match the given Pointer log level.
	 */
	updateLogLevel(): void;
