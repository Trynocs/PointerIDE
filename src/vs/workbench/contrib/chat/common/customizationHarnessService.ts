 ...
 *
 * The default (core) registration exposes a single "Pointer" harness
...
export interface ICustomizationHarnessService {
	 ...
	 * Pointer harness falls back to the core prompts service.
	 */
	 ...
	 * Provider-backed harnesses resolve their own items directly; the default Pointer harness falls back to the core prompts service.
	 */
...
/**
 * Creates a "Pointer" harness descriptor that shows all storage sources
