...
/**
 * Allows webviews to monitor when an element in the Pointer editor is being dragged/dropped.
 *
 * This is required since webview end up eating the drag event. Pointer needs to see this
