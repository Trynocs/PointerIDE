...
const DEFAULT_CONTENT: string = [
	`// ${nls.localize('displayLanguage', 'Defines the keyboard layout used in Pointer in the browser environment.')}`,
	`// ${nls.localize('doc', 'Open Pointer and run "Developer: Inspect Key Mappings (JSON)" from Command Palette.')}`,
	``,
