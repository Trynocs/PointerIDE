...
/**
 * The main Pointer application. There will only ever be one instance,
...
export class CodeApplication extends Disposable {
	...
	async startup(): Promise<void> {
		this.logService.debug('Starting Pointer');
		...
		// "com.microsoft.", which breaks native tabs for Pointer when using this
