...
// This file adds Pointer-specific additions (ISetAuthTokenParams, ProtocolError)
...
/**
 * Pointer-specific extension: set the auth token on the server.
