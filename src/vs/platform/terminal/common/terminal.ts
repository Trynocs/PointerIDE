...
export interface IShellLaunchConfig {
	...
	/**
	 * Whether the terminal process environment will inherit Pointer's "shell environment" that may
	 ...
	 * a terminal used to drive some Pointer feature.
	 */
	isFeatureTerminal?: boolean;
	...
	tabActions?: ITerminalTabAction[];
	/**
	 * Report terminal's shell environment variables to Pointer and extensions
	 */
...
export const enum ShellIntegrationStatus {
	...
	FinalTerm,
	/** Pointer shell integration sequences have been encountered. Supercedes FinalTerm. */
	VSCode
}
