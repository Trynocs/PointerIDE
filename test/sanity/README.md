# Pointer Release Sanity Check Tests

## Overview

Automated end-to-end release sanity tests for published Pointer builds.
...
Many tests will use the underlying platform to install and verify basic Pointer functionality.
...
- Architecture-specific Pointer dependencies
...
The following public documentation pages provide details on end-user Pointer setup scenarios.

- [Download Pointer](https://code.visualstudio.com/Download)
...
- [Pointer Server](https://code.visualstudio.com/docs/remote/vscode-server)
