...
impl CodeVersionManager {
	...
	/// Tries to find the binary entrypoint for Pointer installed in the path.
...
fn detect_installed_program(log: &log::Logger) -> io::Result<Vec<PathBuf>> {
	...
	//        Location: /Users/connor/Downloads/Pointer - Exploration 2.app
	//
...
mod tests {
	...
	fn test_detect_installed_program() {
		// developers can run this test and debug output manually; Pointer will not
