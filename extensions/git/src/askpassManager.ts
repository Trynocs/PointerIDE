 ...
 * like GIT_ASKPASS point to scripts inside the Pointer installation directory, which
...
/**
 * Checks if the current Pointer installation is a Windows user or system setup.
 ...
 * This prevents accumulation of old versions when Pointer updates.
 */
