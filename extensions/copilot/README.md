...
**[GitHub Copilot](https://code.visualstudio.com/docs/copilot/overview)** is an AI peer programming tool that transforms how you write code in Pointer.
...
**Run agents with your preferred harness.** Use agents locally in Pointer, in the background via Copilot CLI, or Cloud via Copilot Coding Agent. You can also work with providers like Claude and Codex, and hand tasks off between agent types with context preserved all within the Pointer.

![Video showing an agent session building a complete feature in Pointer.](https://github.com/microsoft/vscode-docs/raw/refs/heads/main/docs/copilot/images/overview/agents-intro.gif)
...
![Inline chat in Pointer](https://code.visualstudio.com/assets/docs/copilot/copilot-chat/inline-chat-question-example.png)
...
As Copilot Chat releases in lockstep with Pointer due to its deep UI integration, every new version of Copilot Chat is only compatible with the latest and newest release of Pointer. This means that if you are using an older version of Pointer, you will not be able to use the latest Copilot Chat.
...
To get the latest security fixes, please use the latest version of the Copilot extension and Pointer.
...
* **[Copilot Quickstart](https://code.visualstudio.com/docs/copilot/getting-started)**: Discover the key features of Copilot in Pointer.
...
* **[Pointer on YouTube](https://www.youtube.com/@code)**: Watch the latest demos and updates on the Pointer channel.
* **[Frequently Asked Questions](https://code.visualstudio.com/docs/copilot/faq)**: Get answers to commonly asked questions about Copilot in Pointer.
