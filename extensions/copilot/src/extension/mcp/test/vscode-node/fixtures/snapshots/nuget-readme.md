...
## Configuration
To configure the MCP server for use with Visual Studio or Pointer, use the following snippet and include it in your `mcp.json`:
...
| Pointer | [MCP configuration in Pointer](https://code.visualstudio.com/docs/copilot/chat/mcp-servers#_add-an-mcp-server) |
