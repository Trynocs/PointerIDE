...
This document explains the architecture of trajectory logging in Pointer Copilot Chat,
...
│  2. token.chatSessionId         │  Pointer chat session ID     │
│  3. generateSessionId(label)    │  Fallback: hash + timestamp  │
└─────────────────────────────────────────────────────────────────┘
```

This enables:
- **Main trajectories**: Use Pointer's chat session ID for 1:1 mapping
