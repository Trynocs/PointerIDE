 ...
 * be non-deferred. These are core tools provided by Pointer or dynamically
 * injected tools.
 */
const additionalNonDeferredToolNames = new Set<string>([
	// Core tools provided by Pointer (not registered via ToolRegistry.registerTool)
	...
	'task_complete',
	// Pointer built-in language tools that should always be available
	'vscode_renameSymbol',
