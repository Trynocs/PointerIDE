...
export interface IClaudeSlashCommandHandler {
	...
	/**
	 * Optional Pointer command ID for Command Palette registration.
	 * If provided, the command will be registered as a Pointer command
 ...
 *    - Under `contributes.commands`: Add the Pointer command (e.g., `copilot.claude.mycommand`)
