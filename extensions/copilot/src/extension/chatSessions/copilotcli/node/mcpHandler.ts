...
/** The user-facing display label of an MCP server (from Pointer settings). */
 ...
 * to Pointer MCP server display labels.
 */
 ...
 * @param mcpServerMappings Maps friendly server names (from agent files) → Pointer MCP display labels.
