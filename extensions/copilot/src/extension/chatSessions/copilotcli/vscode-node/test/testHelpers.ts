...
/**
* Creates a mock Pointer text editor for testing selection and text retrieval.
*/
...
/**
* Creates a mock Pointer URI for testing.
*/
...
/**
* Creates a mock Pointer text editor with a specific URI scheme for testing.
*/
...
/**
* Creates a mock Pointer Diagnostic for testing.
*/
