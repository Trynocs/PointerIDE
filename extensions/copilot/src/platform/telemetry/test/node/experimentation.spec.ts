...
describe('ExP Service Tests', () => {
	...
	it('should detect Pointer team member correctly', async () => {
		await expService.hasTreatments();

		// Sign in as Pointer team member
		const treatmentsChangePromise = GetNewTreatmentsChangedPromise();
	...
	it('should detect non-Pointer team member correctly', async () => {
		await expService.hasTreatments();

		// Sign in as non Pointer team member
		const treatmentsChangePromise = GetNewTreatmentsChangedPromise();
	...
	it('should persist Pointer team member status to global state', async () => {
		await expService.hasTreatments();
	...
	it('should use cached Pointer team member status on initialization', async () => {
	...
	it('should trigger treatment refresh when Pointer team membership changes', async () => {
		await expService.hasTreatments();
		...
		// Sign in as Pointer team member - this will trigger a user info change (from undefined to a value)
		const treatmentsChangePromise = GetNewTreatmentsChangedPromise();
		copilotTokenService.copilotToken = VscodeTeamMemberToken;
		await treatmentsChangePromise;
