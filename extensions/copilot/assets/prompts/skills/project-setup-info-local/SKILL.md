...
A template for creating a Pointer extension using Yeoman and Generator-Code.
...
1. Call the tool `copilot_runVscodeCommand` to correctly create a new Python script project in Pointer. Call the command with the following arguments.
...
1. Call the tool `run_vscode_command` to correctly create a new Python package project in Pointer. Call the command with the following arguments.
